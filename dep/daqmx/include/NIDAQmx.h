...
/******************************************************/
/***             cppDaq Sync Connections              ***/
/******************************************************/

int32 __CFUNC DAQmxAutoConfigurecppDaqSyncConnections(const char chassisDevicesPorts[], float64 timeout);
int32 __CFUNC DAQmxGetAutoConfiguredcppDaqSyncConnections(char portList[], uInt32 portListSize);
int32 __CFUNC DAQmxAreConfiguredcppDaqSyncPortsDisconnected(const char chassisDevicesPorts[], float64 timeout, bool32* disconnectedPortsExist);
int32 __CFUNC DAQmxGetDisconnectedcppDaqSyncPorts(char portList[], uInt32 portListSize);
int32 __CFUNC DAQmxAddcppDaqSyncConnection(const char portList[]);
int32 __CFUNC DAQmxRemovecppDaqSyncConnection(const char portList[]);
...
#define DAQmxErrorTooManyDevicesForAnalogMultiEdgeTrigcppDaq                              (-209828)
...
#define DAQmxErrorcppDaqMissingDSAMasterForChanExpansion                                  (-201484)
#define DAQmxErrorcppDaqMasterNotFoundForChanExpansion                                    (-201483)
...
#define DAQmxErrorcppDaqSyncMasterClockNotPresent                                         (-201468)
...
#define DAQmxErrorInvalidOutputToInputcppDaqSyncConnection                                (-201462)
#define DAQmxErrorReferenceClockNotPresent                                              (-201461)
#define DAQmxErrorBlankStringExpansionFoundNoSupportedcppDaqSyncConnectionDevices         (-201460)
#define DAQmxErrorNoDevicesSupportcppDaqSyncConnections                                   (-201459)
#define DAQmxErrorInvalidcppDaqSyncTimeoutValue                                           (-201458)
#define DAQmxErrorcppDaqSyncConnectionToSamePort                                          (-201457)
#define DAQmxErrorDevsWithoutCommonSyncConnectionStrategy                               (-201456)
#define DAQmxErrorNocppDaqSyncBetweenPhysAndSimulatedDevs                                 (-201455)
...
#define DAQmxErrorDeviceDoesNotSupportcppDaqSyncConnections                               (-201450)
#define DAQmxErrorInvalidcppDaqSyncPortConnectionFormat                                   (-201449)
...
#define DAQmxErrorSpecifiedcppDaqSlotNotEmpty                                             (-201161)
#define DAQmxErrorDeviceDoesNotSupportSimulation                                        (-201160)
#define DAQmxErrorInvalidcppDaqSlotNumberSpecd                                            (-201159)
#define DAQmxErrorCSeriesModSimMustMatchcppDaqChassisSim                                  (-201158)
...
#define DAQmxErrorLineConflictcppDaq                                                      (-201133)
...
#define DAQmxErrorTooManyChansForAnalogRefTrigcppDaq                                      (-201123)
...
#define DAQmxErrorBufferedOpsNotSupportedInSpecdSlotForcppDaq                             (-201107)
#define DAQmxErrorPhysChanNotSupportedInSpecdSlotForcppDaq                                (-201106)
#define DAQmxErrorResourceReservedWithConflictingSettings                               (-201105)
#define DAQmxErrorInconsistentAnalogTrigSettingscppDaq                                    (-201104)
#define DAQmxErrorTooManyChansForAnalogPauseTrigcppDaq                                    (-201103)
#define DAQmxErrorAnalogTrigNotFirstInScanListcppDaq                                      (-201102)
