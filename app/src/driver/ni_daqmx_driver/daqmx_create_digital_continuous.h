...
#ifndef __aarch64__
class daqmxCreateDigitalContinuous final {
private:
...
public:
    ...
    daqmxCreateDigitalContinuous(const std::string device_name, digital_pins_continuous digital_io_ids);

    ~daqmxCreateDigitalContinuous();
};
#endif